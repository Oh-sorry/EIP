    ...
    <div id="container">
        <div class="inner">        
            ...
            <form id="boardForm" name="boardForm">
				...
				<div class="page_info">
					<span class="total_count"><strong>전체 차량</strong> : <span id="total_count" class="t_red">0</span>개</span>
				</div>
            ...
            <div class="btn_right mt15">
                <button type="button" class="btn black mr5" onclick="javascript:goBoardWrite();">등록하기</button>
            </div>
        </div>
