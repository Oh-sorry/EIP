...
<script type="text/javascript">
    ...
    function updateBoard(){
        ...
        var yn = confirm("차량 정보를 수정하시겠습니까?");        
        if(yn){
    ...
    function updateBoardCallback(obj){
        ...
        if(obj != null){        
            ...
            if(result == "SUCCESS"){                
                alert("차량 정보 수정을 성공하였습니다.");                
                goBoardList();                 
            } else {                
                alert("차량 정보 수정을 실패하였습니다.");    
                return;
            }
        }
    }
        ...
        <div class="inner">    
            ...
            <form id="boardForm" name="boardForm">    
                ...
                <caption><strong><span class="t_red">*</span> 표시는 필수입력 항목입니다.</strong></caption>
                    ...
                    <tbody id="tbody">
                       <tr>
                            <th>차량 번호<span class="t_red">*</span></th>
                        ...
                        <tr>
                            <th>추가사항<span class="t_red">*</span></th>
